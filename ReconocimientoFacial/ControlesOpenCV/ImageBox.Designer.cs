namespace ReconocimientoFacial
{
   partial class ImageBox
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.fileOperationToolStripMenuItem.Text = global::ReconocimientoFacial.Properties.StringTable.File;
         // 
         // loadImageToolStripMenuItem
         // 
         this.loadImageToolStripMenuItem.Name = "loadImageToolStripMenuItem";
         this.loadImageToolStripMenuItem.Size = new System.Drawing.Size(145, 22);
         this.loadImageToolStripMenuItem.Text = global::ReconocimientoFacial.Properties.StringTable.LoadImage;
         ...
         this.saveImageToolStripMenuItem.Text = global::ReconocimientoFacial.Properties.StringTable.SaveAs;
         ...
         this.filtersToolStripMenuItem.Text = global::ReconocimientoFacial.Properties.StringTable.Filters;
         // 
         ...
         this.zoomToolStripMenuItem.Text = global::ReconocimientoFacial.Properties.StringTable.Zoom;
         // 
         // zoomInToolStripMenuItem
         // 
         this.zoomInToolStripMenuItem.Name = "zoomInToolStripMenuItem";
         this.zoomInToolStripMenuItem.Size = new System.Drawing.Size(129, 22);
         this.zoomInToolStripMenuItem.Text = global::ReconocimientoFacial.Properties.StringTable.ZoomIn;
         ...
         this.zoomOutToolStripMenuItem.Text = global::ReconocimientoFacial.Properties.StringTable.ZoomOut;
         ...
         this.unZoomToolStripMenuItem.Text = global::ReconocimientoFacial.Properties.StringTable.UnZoom;
         ...
         this.propertyToolStripMenuItem.Text = global::ReconocimientoFacial.Properties.StringTable.Property;
    ...
    "p;*.png;*.tiff;*.tif|All Files(*.*)|*.*";
         this.loadImageFromFileDialog.Title = global::ReconocimientoFacial.Properties.StringTable.LoadImage;
         // 
         // saveImageToFileDialog
         // 
         this.saveImageToFileDialog.Filter = "Image Files (*.jpg;*.jpeg;*.gif;*.bmp;*.png;*.tiff;*.tif)|*.jpg;*.jpeg;*.gif;*.bm" +
    "p;*.png;*.tiff;*.tif|All Files(*.*)|*.*";
         this.saveImageToFileDialog.Title = global::ReconocimientoFacial.Properties.StringTable.SaveImageDialogText;
         // 
         // ImageBox
         // 
